...
The mini engine is intentionally a **learning-oriented implementation**. It is not intended to compete with production inference systems. Its purpose is to make the mechanisms understandable enough to measure, debug, and compare.

---

# Results First

The mini engine has now been validated through correctness tests and controlled inference benchmarks.

## KV-Cache Correctness

The cached and uncached generation paths are tested against each other under deterministic greedy decoding.
...
The KV-cache correctness tests specifically cover:
...
The key correctness requirement is:
...
The most important debugging lesson from the KV-cache implementation was:
